...
public class ScrabbleTest {
    ...
    public static void main(String[] args) {
        ...
        LinkedList<String> playerTwoTiles = singleton.getTiles(7);
        System.out.println("Player 3: " + playerTwoTiles);
        Singleton instance3 = Singleton.getInstance();
        // Get unique id for the new instance object
        System.out.println("2nd Instance ID: " + System.identityHashCode(instance3));
        // This returns the value of the first instance created
        System.out.println(instance3.getLetterList());
        // Player 2 draws 7 tiles
        LinkedList<String> player3Tiles = newInstance.getTiles(7);
        System.out.println("Player 2: " + player3Tiles);
    }
}