 ...
 *
 * In this example we will see that Swig is selling food products now suddenly lockdown arise,
 * and they thought to provide service of delivering grocery items for some time, so they write adapter which
...
public class Main {
    public static void main(String[] args) {
        SwigStore swiggyStore = new SwigStore();
